              ...
              <div class="eight columns">
                  <div class="row">
                      <div class="main-nav">
                        ...
                        <div class="two columns"><a href="<?php bloginfo( 'url' ); ?>/?page_id=73">ABOUT US</a></div> 
                        <div class="three columns"><a href="<?php bloginfo( 'url' ); ?>/?page_id=8">OUR PRODUCTS</a></div>
                        <div class="two columns"><a href="<?php bloginfo( 'url' ); ?>/?page_id=75">NEWS</a></div>
                        <div class="three columns"><a href="<?php bloginfo( 'url' ); ?>/?page_id=77">CONTACT US</a></div>
                      </div>
                  </div>
              </div>
          </div>        
